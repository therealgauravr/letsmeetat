<div class="font-satoshi-regular p-12 w-full sm:w-10/12 sm:mx-40 text-center">
	<p class="font-satoshi-bold text-2xl">TERMS OF SERVICE</p>

	<p>----</p>

	<p class="font-satoshi-bold text-xl">OVERVIEW</p>

	<p>
		This website is operated by Letsmeetat. Throughout the site, the terms &ldquo;we&rdquo;,
		&ldquo;us&rdquo; and &ldquo;our&rdquo; refer to Letsmeetat. Letsmeetat offers this website,
	...
	<p>
		...
		&ldquo;Service&rdquo; and agree to be bound by the following terms and conditions (&ldquo;Terms
		of Service&rdquo;, &ldquo;Terms&rdquo;), including those additional terms and conditions and
		policies referenced herein and/or available by hyperlink. These Terms of Service apply to all
		users of the site, including without limitation users who are browsers, vendors, customers,
	...
	<p class="font-satoshi-bold text-xl">SECTION 1 - ONLINE STORE TERMS</p>
	...
	<p class="font-satoshi-bold text-xl">SECTION 2 - GENERAL CONDITIONS</p>
	...
	<p class="font-satoshi-bold text-xl">SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</p>
	...
	<p class="font-satoshi-bold text-xl">SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</p>
	...
	<p class="font-satoshi-bold text-xl">SECTION 5 - PRODUCTS OR SERVICES (if applicable)</p>
	...
	<p>
		...
		according to our Return Policy. To view our Return Policy, please visit [LINK TO RETURN POLICY]
	</p>
	...
	<p class="font-satoshi-bold text-xl">SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</p>
	...
	<p class="font-satoshi-bold text-xl">SECTION 7 - OPTIONAL TOOLS</p>
	...
	<p class="font-satoshi-bold text-xl">SECTION 8 - THIRD-PARTY LINKS</p>
	...
	<p class="font-satoshi-bold text-xl">SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</p>
	...
	<p>
		...
		otherwise objectionable or violates any party&rsquo;s intellectual property or these Terms of Service.<br
		/>
		...
		any related website. You may not use a false e-mail address, pretend to be someone other than yourself,
	...
	<p class="font-satoshi-bold text-xl">SECTION 10 - PERSONAL INFORMATION</p>

	<p>
		Your submission of personal information through the store is governed by our Privacy Policy. To
		view our Privacy Policy, please see [LINK TO PRIVACY POLICY]
	</p>

	<p class="font-satoshi-bold text-xl">SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</p>
	...
	<p class="font-satoshi-bold text-xl">SECTION 12 - PROHIBITED USES</p>
	...
	<p>
		...
		or disability; (f) to submit false or misleading information;<br />
		(g) to upload or transmit viruses or any other type of malicious code that will or may be used in
		any way that will affect the functionality or operation of the Service or of any related website,
		other websites, or the Internet; (h) to collect or track the personal information of others; (i)
		to spam, phish, pharm, pretext, spider, crawl, or scrape; (j) for any obscene or immoral purpose;
		or (k) to interfere with or circumvent the security features of the Service or any related website,
		other websites, or the Internet. We reserve the right to terminate your use of the Service or any
		related website for violating any of the prohibited uses.
	</p>

	<p class="font-satoshi-bold text-xl">SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</p>
	...
	<p>
		...
		stated by us) provided 'as is' and 'as available' for your use, without any representation, warranties
		...
		non-infringement.<br />
		In no case shall Letsmeetat, our directors, officers, employees, affiliates, agents, contractors,
		...
		made available via the service, even if advised of their possibility.<br />
	...
	<p class="font-satoshi-bold text-xl">SECTION 14 - INDEMNIFICATION</p>

	<p>
		You agree to indemnify, defend and hold harmless Letsmeetat and our parent, subsidiaries,
	...
	<p class="font-satoshi-bold text-xl">SECTION 15 - SEVERABILITY</p>
	...
	<p class="font-satoshi-bold text-xl">SECTION 16 - TERMINATION</p>
	...
	<p class="font-satoshi-bold text-xl">SECTION 17 - ENTIRE AGREEMENT</p>
	...
	<p class="font-satoshi-bold text-xl">SECTION 18 - GOVERNING LAW</p>
	...
	<p class="font-satoshi-bold text-xl">SECTION 19 - CHANGES TO TERMS OF SERVICE</p>
	...
	<p class="font-satoshi-bold text-xl">SECTION 20 - CONTACT INFORMATION</p>

	<p>Questions about the Terms of Service should be sent to us at team@neutron.money.</p>
