<div class="font-satoshi-regular p-12 sm:w-10/12 sm:mx-40 text-left">
	<p class="font-satoshi-bold text-2xl mb-10">Letsmeetat <br /> Privacy Policy</p>

	<p>
		This Privacy Policy describes how your personal information is collected, used, and shared when
		you visit or make a purchase from https://letsmeet.at (the &ldquo;Site&rdquo;).
	</p>
	<br />

	<p class="font-satoshi-bold text-xl mb-5">PERSONAL INFORMATION WE COLLECT</p>
	...
	<p>
		...
		automatically-collected information as &ldquo;Device Information.&rdquo;
	</p>
	...
	<p>
		...
		address, browser type, Internet service provider, referring/exit pages, and date/time stamps.<br
		/>
		- &ldquo;Web beacons,&rdquo; &ldquo;tags,&rdquo; and &ldquo;pixels&rdquo; are electronic files used
		to record information about how you browse the Site.<br />
		...
		(including credit card numbers [[INSERT ANY OTHER PAYMENT TYPES ACCEPTED]]), email address, and phone
	...
	<br />
	<p class="font-satoshi-bold text-xl mb-5">HOW DO WE USE YOUR PERSONAL INFORMATION?</p>
	...
	<p>
		...
		success of our marketing and advertising campaigns).<br />
		[[INSERT OTHER USES OF DEVICE INFORMATION, INCLUDING: ADVERTISING/RETARGETING]]<br />
	...
	<p>
		...
		about how Shopify uses your Personal Information here: https://www.shopify.com/legal/privacy. We
		also use Google Analytics to help us understand how our customers use the Site--you can read
	...
	<p>
		...
		receive, or to otherwise protect our rights.<br />
		[[INCLUDE IF USING REMARKETING OR TARGETED ADVERTISING]]<br />
		...
		targeted advertising works, you can visit the Network Advertising Initiative&rsquo;s (&ldquo;NAI&rdquo;)
	...
	<p>
		...
		Additionally, you can opt out of some of these services by visiting the Digital Advertising Alliance&rsquo;s
		opt-out portal at: http://optout.aboutads.info/.
	</p>
	<br />
	<p class="font-satoshi-bold text-xl mb-5">
		DO NOT TRACK<br />
		Please note that we do not alter our Site&rsquo;s data collection and use practices when we see a
	...
	<p>
		<br />
		<span class="font-satoshi-bold text-xl mb-5">YOUR RIGHTS</span><br />
		...
		exercise this right, please contact us through the contact information below.<br />
	...
	<p>
		<br />
		<span class="font-satoshi-bold text-xl mb-5">DATA RETENTION</span><br />
	...
	<p>
		<span class="font-satoshi-bold text-xl mb-5">MINORS</span><br />
		The Site is not intended for individuals under the age of [[INSERT AGE]].
	</p>
	<br />
	<p>
		<span class="font-satoshi-bold text-xl mb-5">CHANGES</span><br />
		...
		<br />
		<span class="font-satoshi-bold text-xl mb-5"> CONTACT US</span><br />
		For more information about our privacy practices, if you have questions, or if you would like to
		make a complaint, please contact us by e-mail at team@neutron.money or by mail using the details
		provided below:
	</p>

	<p class="pl-10 font-satoshi-bold">103, Raheja Arbor, St. Johns Road, Bangalore, KA, 560042, India</p>
</div>
